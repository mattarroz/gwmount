...
#endif
#else
#if defined _WIN32 || HAVE_LIBSAFEC
// FIXME(mreis): is this really correct?
	strcpy_s(reinterpret_cast<char *> (output), maxLength, input);
#else
	strcpy(output, input);
#endif
#endif
...
#else
	// FIXME(mreis): why const cast?
	return BRIDGE_DriverSetCurrentComPort(m_handle, const_cast<char *> (comPort));
#endif
}
