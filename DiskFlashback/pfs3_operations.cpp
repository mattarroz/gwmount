...
uint32_t DokanFileSystemAmigaPFS3::amigaToWindowsAttributes(const IPFS3::FileInformation& fileInfo) {
    uint32_t ret = fileInfo.isDirectory ? FILE_ATTRIBUTE_DIRECTORY : 0;
