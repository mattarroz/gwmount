...
SectorRW_DMS::SectorRW_DMS(void* fle) : SectorCacheEngine(512 * 84 * 2 * 2 * 11) {
...
bool SectorRW_DMS::unpackCylinders(void* fle, uint8_t* b1, uint8_t* b2, uint8_t* text) {
    uint32_t read;
    m_totalTracks = 0;
...
// Parse the DMS
bool SectorRW_DMS::parseDMSHeader(void* fle, uint8_t* b1, uint8_t* b2, uint8_t* text) {
