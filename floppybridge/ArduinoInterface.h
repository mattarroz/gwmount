...
namespace ArduinoFloppyReader {
	...
	public:
		...
		DiagnosticResponse writeFlux(const std::vector<uint32_t>& fluxTimes, const uint32_t offsetFromIndex, const float driveRPM, bool compensateFluxTimings, bool terminateAtIndex = false);
