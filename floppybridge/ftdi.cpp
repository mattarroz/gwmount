...
typedef FTDI::FT_STATUS (CALLING_CONVENTION *_FT_OpenEx)(LPVOID pArg1, uint32_t Flags, FT_HANDLE *pHandle);
typedef FTDI::FT_STATUS (CALLING_CONVENTION *_FT_ListDevices)( LPVOID pArg1, LPVOID pArg2, uint32_t Flags);
...
typedef FTDI::FT_STATUS (CALLING_CONVENTION *_FT_Read)(FT_HANDLE ftHandle, LPVOID lpBuffer, uint32_t nBufferSize, LPDWORD lpBytesReturned);
typedef FTDI::FT_STATUS (CALLING_CONVENTION *_FT_Write)(FT_HANDLE ftHandle, LPVOID lpBuffer, uint32_t nBufferSize, LPDWORD lpBytesWritten);
typedef FTDI::FT_STATUS (CALLING_CONVENTION *_FT_IoCtl)(FT_HANDLE ftHandle, uint32_t dwIoControlCode, LPVOID lpInBuf, uint32_t nInBufSize, LPVOID lpOutBuf, uint32_t nOutBufSize, LPDWORD lpBytesReturned, LPOVERLAPPED lpOverlapped);
...
typedef FTDI::FT_STATUS (CALLING_CONVENTION *_FT_SetEventNotification)(FT_HANDLE ftHandle,uint32_t Mask,LPVOID Param);
...
typedef FTDI::FT_STATUS (CALLING_CONVENTION* _FT_GetDeviceInfoDetail)(uint32_t dwIndex, LPDWORD lpdwFlags, LPDWORD lpdwType, LPDWORD lpdwID, LPDWORD lpdwLocId, char* pcSerialNumber, char* pcDescription, FT_HANDLE* ftHandle);
...
FTDI::FT_STATUS FTDIInterface::FT_OpenEx(LPVOID pArg1, uint32_t Flags) {
	if (::FT_OpenEx) {
...
FTDI::FT_STATUS FTDIInterface::FT_ListDevices(LPVOID pArg1, LPVOID pArg2, uint32_t Flags) {
...
FTDI::FT_STATUS FTDIInterface::FT_Read(LPVOID lpBuffer, uint32_t nBufferSize, LPDWORD lpBytesReturned) {
	if ((::FT_Read) && (m_handle)) return ::FT_Read(m_handle, lpBuffer, nBufferSize, lpBytesReturned);
	return FTDI::FT_STATUS::FT_DRIVER_NOT_AVAILABLE;
};

FTDI::FT_STATUS FTDIInterface::FT_Write(LPVOID lpBuffer, uint32_t nBufferSize, LPDWORD lpBytesWritten) {
	if ((::FT_Write) && (m_handle)) return ::FT_Write(m_handle, lpBuffer, nBufferSize, lpBytesWritten);
	return FTDI::FT_STATUS::FT_DRIVER_NOT_AVAILABLE;
};

FTDI::FT_STATUS FTDIInterface::FT_IoCtl(uint32_t dwIoControlCode, LPVOID lpInBuf, uint32_t nInBufSize, LPVOID lpOutBuf, uint32_t nOutBufSize, LPDWORD lpBytesReturned, LPOVERLAPPED lpOverlapped) {
...
FTDI::FT_STATUS FTDIInterface::FT_SetEventNotification(uint32_t Mask, LPVOID Param) {
...
FTDI::FT_STATUS FTDIInterface::FT_GetDeviceInfoDetail(uint32_t dwIndex, LPDWORD lpdwFlags, LPDWORD lpdwType, LPDWORD lpdwID, LPDWORD lpdwLocId, char* pcSerialNumber, char* pcDescription, FT_HANDLE* handle) {
